...
public class SliderDialog extends javax.swing.JDialog {
    ...
    private static int smallChange = 5;
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("net/Mchien/NhanDangCongVanOcr/SliderDialog"); // NOI18N
        ...
        jSlider1.setValue(0);
        jSlider1.setPreferredSize(new java.awt.Dimension(202, 73));
