...
import net.Mchien.NhanDangCongVan.util.FixedSizeStack;
...
public class GuiWithImage extends GuiWithBulkOCR {
    ...
    void jMenuItemAutocropActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        originalImage = (BufferedImage) iioImageList.get(imageIndex).getRenderedImage();
        BufferedImage croppedImage = net.Mchien.NhanDangCongVan.util.ImageHelper.autoCrop(originalImage, 0.1);
        // if same image, skip
        ...
        dialog.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals(SliderDialog.VALUE_CHANGED)) {
                    ...
                    imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.brighten(originalImage, value));
                    imageList.set(imageIndex, imageIcon);
                    iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
                    displayImage();
                }
    ...
    void jMenuItemContrastActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        dialog.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals(SliderDialog.VALUE_CHANGED)) {
                    int value = (Integer) evt.getNewValue();
                    imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.contrast(originalImage, value * 0.02f));
                    imageList.set(imageIndex, imageIcon);
                    iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
                    displayImage();
                }
    ...
    void jMenuItemGammaActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        dialog.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals(SliderDialog.VALUE_CHANGED)) {
                    int value = (Integer) evt.getNewValue();
                    imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.gamma(originalImage, value * 0.1f));
                    imageList.set(imageIndex, imageIcon);
                    iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
                    displayImage();
                }
        ...
        dialog.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals(DoubleSliderDialog.VALUE_CHANGED)) {
                    ...
                    imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.adaptiveThreshold(originalImage,
    ...
    void jMenuItemSharpenActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        originalImage = (BufferedImage) iioImageList.get(imageIndex).getRenderedImage();
        stack.push(originalImage);
        imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.sharpen(originalImage));
        imageList.set(imageIndex, imageIcon);
        iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
        displayImage();
    }
    ...
    void jMenuItemSmoothActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        originalImage = (BufferedImage) iioImageList.get(imageIndex).getRenderedImage();
        stack.push(originalImage);
        imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.smoothen(originalImage));
        imageList.set(imageIndex, imageIcon);
        iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
        displayImage();
    }
    ...
    void jMenuItemBilateralActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                originalImage = (BufferedImage) iioImageList.get(imageIndex).getRenderedImage();
                stack.push(originalImage);
                imageIcon = new ImageIconScalable(net.Mchien.NhanDangCongVan.util.ImageHelper.bilateralFiltering(originalImage, 3.0, 3.0));
                imageList.set(imageIndex, imageIcon);
                iioImageList.get(imageIndex).setRenderedImage((BufferedImage) imageIcon.getImage());
