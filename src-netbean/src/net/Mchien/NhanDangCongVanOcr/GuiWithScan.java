...
import net.Mchien.NhanDangCongVan.wia.WiaScannerAdapter;
import net.Mchien.NhanDangCongVan.wia.FormatID;
import net.Mchien.NhanDangCongVan.wia.WiaOperationException;
